    ...
    def get(self, p_Id):
        if self.user_loggedin(self.user):
            ...
            if post:
                ...
                liked = LikeModel(user_id=str(self.user.key().id()), post_id=p_Id)
                liked.put()
    ...
    def get(self, p_Id):
        if self.user_loggedin(self.user):
            ...
            if post:
                ...
                disliked = DislikeModel(user_id=str(self.user.key().id()), post_id=p_Id)
                disliked.put()
...
app = webapp2.WSGIApplication([('/', MainPage),
                               ...
                               ('/blog/?', BlogFront),
                               ('/blog/([0-9]+)', PostPage),        #[0-9] is passed as the id for searching a particular post
